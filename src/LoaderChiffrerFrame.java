...
public class LoaderChiffrerFrame extends JFrame{
    ...
    public static void fin(LoaderChiffrerFrame loaderChiffrerFrame) {
        loaderChiffrerFrame.LTitre.setText("Chiffrement terminé !");
        loaderChiffrerFrame.BtValider.setEnabled(true);
        Icon imgIcon = new ImageIcon(Objects.requireNonNull(loaderChiffrerFrame.getClass().getResource("Image/valide5.png")));
        loaderChiffrerFrame.LImage.setIcon(imgIcon);
    }
